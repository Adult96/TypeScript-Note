...
function destructuring({ student, age2 }: Istudent) {
...
function 함수11_2({ user, comment, admin }: I함수3): void {
...
function 함수11_3([a, b, c]: (number | boolean | string)[]): void {
  console.log(a, b, c);
}
